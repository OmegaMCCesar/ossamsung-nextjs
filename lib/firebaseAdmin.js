...
const privateKeyEnv = process.env.NEXT_FIREBASE_ADMIN_PRIVATE_KEY;
const clientEmailEnv = process.env.NEXT_FIREBASE_ADMIN_CLIENT_EMAIL;
const projectIdEnv = process.env.NEXT_FIREBASE_ADMIN_PROJECT_ID;
